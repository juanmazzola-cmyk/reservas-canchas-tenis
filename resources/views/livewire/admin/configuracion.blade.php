        ...
        <div class="bg-white rounded-2xl shadow-sm p-5">
            ...
            <div class="space-y-3">
                <div>
                    ...
                    <div class="flex items-center border border-gray-300 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-[#0057a8] @error('admin_whatsapp') border-red-400 @enderror">
                        <span class="bg-gray-100 border-r border-gray-300 px-3 py-2 text-sm text-gray-500 font-medium select-none">+54</span>
                        <input type="text" wire:model="admin_whatsapp" placeholder="1112345678 (sin 0, sin 15)"
