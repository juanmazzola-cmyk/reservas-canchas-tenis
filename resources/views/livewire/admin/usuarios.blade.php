            ...
            <div class="flex-1 min-w-0">
                ...
                @if($u['telefono'])
                    <div class="flex items-center gap-1.5 mt-0.5">
                        ...
                        <a href="https://wa.me/54{{ ltrim(preg_replace('/\D/', '', $u['telefono']), '0') }}" target="_blank"
                            class="flex-shrink-0">
        ...
        <div class="bg-white rounded-t-2xl sm:rounded-2xl w-full sm:max-w-md shadow-xl max-h-[90vh] flex flex-col">
            ...
            <div class="p-6 space-y-4 overflow-y-auto flex-1">
                ...
                <div class="flex items-center gap-3 bg-gray-50 rounded-lg px-4 py-3">
                    ...
                    <label for="editEsSocio" class="text-sm text-gray-700">Es socio de tenis</label>
                </div>

                @if($editEsSocio)
                <div>
                    <label class="block text-xs font-medium text-gray-600 mb-1">Número de socio del club <span class="text-gray-400 font-normal">(opcional)</span></label>
