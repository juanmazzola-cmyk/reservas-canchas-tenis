        ...
        <div class="p-6 sm:p-5 flex-shrink-0">
            ...
            <div class="mb-5">
                ...
                <div class="relative">
                    ...
                    />
                    <button type="button"
                        onclick="var i=document.getElementById('password-input'); i.type=i.type==='password'?'text':'password'; this.querySelectorAll('svg').forEach(s=>s.classList.toggle('hidden'));"
                        class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                        </svg>
                        <svg class="w-5 h-5 hidden" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <button
                type="button"
                onclick="this.disabled=true; this.innerHTML='Ingresando...'; document.getElementById('login-form').submit()"
                class="w-full bg-[#16a34a] hover:bg-green-700 active:bg-green-800 active:scale-95 text-white font-bold py-3 rounded-lg transition-all duration-150 text-sm tracking-wide">
                INGRESAR
            </button>
